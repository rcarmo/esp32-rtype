...
/**
 * @brief Create new display panel for Tab5 ST7123 integrated display/touch revisions.
 *
 * This helper is present in M5Stack's Tab5 BSP source but is not part of the
 * upstream generic BSP header. It is exposed here only for the Tab5 LC display
 * smoke test so we can choose the ST7123 path after an I2C probe.
 */
esp_err_t bsp_display_new_with_handles_to_st7123(const bsp_display_config_t *config,
