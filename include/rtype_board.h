...
#define RTYPE_BOARD_NAME "ESP32-2432S028 CYD / ESP32"
#define RTYPE_LCD_W 240u
#define RTYPE_LCD_H 320u
#define RTYPE_VIEW_SCALE 1u
#else
#error "Select RTYPE_BOARD_ESP32_8048S043C, RTYPE_BOARD_ESP32_2432S028 or RTYPE_BOARD_M5STACK_TAB5_ESP32P4"
#endif
